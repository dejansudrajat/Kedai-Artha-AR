...
public class ARCamera : MonoBehaviour
{
	...
	public ARKedaiArtha.Test text1;
	public HSController text2;
	...
	void Awake(){
		//link = GameObject.Find ("Camera");
		link = GameObject.Find("Camera");
		text2 = link.GetComponent<HSController> ();
		//text1 = link.GetComponent<ARKedaiArtha.Test> ();
	}
		...
		if (marker == null) {
			...
			if (marker.Visible) {
				...
				if (!arVisible) {
					...
					Debug.Log ("Nongtot");
					arVisible = true;
					//text2.visiblity = true;
					//text2.panel.SetActive(true);
