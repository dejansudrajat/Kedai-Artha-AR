...
public class ARController : MonoBehaviour
{
	...
	public GameObject TampilDekripsi;
	...
	public string videoConfigurationAndroid0 = "-width=640 -height=480";
	...
	public string videoConfigurationAndroid1 = "-width=640 -height=480";
...
//    	AR_MATRIX_CODE_GLOBAL_ID = 2830
...

    {
		...
		if (Application.isPlaying) {
			...
			if (QuitOnEscOrBack && Input.GetKeyDown(KeyCode.Escape)) SceneManager.LoadScene("MenuUtama"); // On Android, maps to "back" button.
	...
	//fungsi kembali pada saat kamera ar aktif
	void Kembali()
	{
	...
	bool UpdateAR()
	{
		...
		if (gotFrame) {
		    if (_sceneConfiguredForVideo && UseVideoBackground) {
	        	UpdateTexture();
				//Debug.Log ("Hmmmmmmmmmmmmmm");
        	}
		}
		return true;
		//GameObject gm = GameObject.Find("TextMarkerTdkTerdeteksi");
		//gm.SetActive (true);
		//Debug.Log ("Haiii 1");
	...
	private void UpdateTexture()
    {
		...
		//Deteksi = GameObject.FindGameObjectWithTag ("Deteksi");
